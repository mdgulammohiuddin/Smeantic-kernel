...
6. If the query references a specific document (e.g., "copilot document"), prioritize content from documents matching that reference, Answers should be retreived from the document only.
